                            ...
                            <div>
                                ...
                                <div className="space-y-3 mb-6">
                                    {invitations
                                        ...
                                        .map((invitation) => (
                                            <div key={invitation.id} className="bg-white border-l-4 border-yellow-500 rounded-lg shadow-sm p-6 hover:shadow-md transition">
                                                <div className="flex items-start justify-between mb-4">
                                                    <div>
                                                        <h3 className="text-lg font-bold text-gray-800">{invitation.groupName || invitation.groupCode}</h3>
                                ...
                                <div className="space-y-3">
                                    {invitations
                                        ...
                                        .map((invitation) => {
                                            ...
                                            return (
                                                <div key={invitation.id} className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 opacity-75">
