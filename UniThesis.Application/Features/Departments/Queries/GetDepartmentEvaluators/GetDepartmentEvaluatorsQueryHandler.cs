...
public class GetDepartmentEvaluatorsQueryHandler : IQueryHandler<GetDepartmentEvaluatorsQuery, List<DepartmentEvaluatorDto>>
{
    ...
    public GetDepartmentEvaluatorsQueryHandler(
    ...
    public async Task<List<DepartmentEvaluatorDto>> Handle(
        GetDepartmentEvaluatorsQuery request,
        CancellationToken cancellationToken)
    {
        ...
        return await _queryService.GetDepartmentEvaluatorsAsync(
